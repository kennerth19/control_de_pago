...
<head>
    ...
    <title>Eventos del dia: <?php echo e(date("d-m-Y",strtotime($date))); ?></title>
</head>
...
<body class="" id="body">
    ...
    <?php if(auth()->user()->email == 'marco' || auth()->user()->email == 'kennerth' || auth()->user()->email == 'antonio' || auth()->user()->email == 'Marcelo'): ?>
    <h1 class="picture_mode_off">Eventos del dia: <?php echo e(date("d-m-Y",strtotime($date))); ?></h1>

    <?php if($j > 0): ?>
    <form id="date_form">
        Resumen del dia: <input type="date" id="date" name="date" value="<?php echo e($date); ?>" onchange="this.form.submit()">
    </form>
    ...
    <div class="div_container" id="div_container">
        <div class="">
            ...
            <?php $__currentLoopData = $evento_diario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <div class="main_container_grid">

                <p><?php echo e($i+=1); ?></p>
                <p class="event_des"><?php echo e($evento->evento); ?></p>
                <p><?php echo e(date("h:i:s a", strtotime($evento->created_at))); ?></p>


                <?php if($evento->total_d >= 1): ?>
                <p class="mas"><?php echo e($evento->total_d+0); ?>$</p>
                <?php elseif($evento->total_d < 0): ?> <p class="menos"><?php echo e($evento->total_d+0); ?>$</p>
                    <?php else: ?>
                    <p><?php echo e($evento->total_d+0); ?>$</p>
                    <?php endif; ?>

                    <?php if($evento->total_bs >= 1): ?>
                    <p class="mas"><?php echo e($evento->total_bs+0); ?>Bs</p>
                    <?php elseif($evento->total_bs < 0): ?> <p class="menos"><?php echo e($evento->total_bs+0); ?>Bs</p>
                        <?php else: ?>
                        <p><?php echo e($evento->total_bs+0); ?>Bs</p>
                        <?php endif; ?>

                        <?php if(auth()->user()->role == 1 || auth()->user()->role == 2 || auth()->user()->email == 'Marcelo'): ?>

                        <form action="<?php echo e(route('evento_diario_delete',$evento->id)); ?>" class="eliminar" method="get">
            ...
            <div class="form_event">
                <form action="<?php echo e(route('evento_diario_print')); ?>" method="get">
                    <p>Total recaudado en dolares: <?php echo e($total_sin_resto+0); ?>$. (Total con resto: <?php echo e($total_d+0); ?>$) | Total recaudado en bolivares: <?php echo e($total_bs+0); ?>Bs.</p>
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="print" value="<?php echo e($date); ?>">
                ...
                <div class="main">
                    ...
                    <form><input type="date" name="date" value="<?php echo e($date); ?>" onchange="this.form.submit()"></form>
            ...
            <div>
                <?php $__currentLoopData = $evento_diario_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($k == 1): ?>
                    <p>Modificaciones de fecha de corte</p>
                    <?php endif; ?>
                    <p><span><?php echo e($k++); ?> - </span><?php echo e($evento->evento); ?></p>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        <?php if(auth()->user()->role == 1 || auth()->user()->role == 2 || auth()->user()->email == 'Marcelo'): ?>
        <form action="<?php echo e(route('evento_diario_add')); ?>" id="del_add" class="form-add picture_mode_off" method="POST">
            <div class="main_form">
                ...
                <label>Fecha:</label>
                <input type="date" name="date_print" value="<?php echo e($hoy); ?>">
...
<?php echo $__env->make('layouts.side_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control_de_pago\resources\views/evento_diario.blade.php ENDPATH**/ ?>