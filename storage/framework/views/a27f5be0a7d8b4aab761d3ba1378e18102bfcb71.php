 ...
 <body onload="date_now()">
     ...
     <div class="on" id="screem_1">
         ...
         <div>
             <div class="item on" id="item_<?php echo e($i); ?>">
                 <?php if($reportes->type == 1): ?>
                 <p class="on"><?php echo e($reportes->id); ?></p>
                 <p class="report_description on"><?php echo e($reportes->descripcion); ?></p>
                 <p class="on"><?php echo e($reportes->created_at); ?></p>
                 <p class="create type on m-auto">Reporte tipo Creacion</p>
                 <?php elseif($reportes->type == 2): ?>
                 <p class="on"><?php echo e($reportes->id); ?></p>
                 <p class="report_description on"><?php echo e($reportes->descripcion); ?></p>
                 <p class="on"><?php echo e($reportes->created_at); ?></p>
                 <p class="activate type on m-auto">Reporte tipo Activacion</p>
                 <?php elseif($reportes->type == 3): ?>
                 <p class="on"><?php echo e($reportes->id); ?></p>
                 <p class="report_description on"><?php echo e($reportes->descripcion); ?></p>
                 <p class="on"><?php echo e($reportes->created_at); ?></p>
                 <p class="desactivate type on m-auto">Reporte tipo desactivar</p>
                 <?php elseif($reportes->type == 4): ?>
                 <p class="on"><?php echo e($reportes->id); ?></p>
                 <p class="report_description on"><?php echo e($reportes->descripcion); ?></p>
                 <p class="on"><?php echo e($reportes->created_at); ?></p>
                 <p class="modificate type on m-auto">Reporte tipo Modificar</p>
                 <?php elseif($reportes->type == 5): ?>
                 <p class="on"><?php echo e($reportes->id); ?></p>
                 <p class="report_description on"><?php echo e($reportes->descripcion); ?></p>
                 <p class="on"><?php echo e($reportes->created_at); ?></p>
     ...
     <div class="off" id="screem_2">
         ...
         <?php $__currentLoopData = $pre_reg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pre_regs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <div class="<?php echo e($pre_regs->date_pay); ?> on all_item">
             <div class="screem_2_item on" id="<?php echo e($j); ?>_table">
                 <p class="on"><?php echo e($pre_regs->id); ?></p>
                 <p class="on"><?php echo e($pre_regs->full_name); ?></p>
                 <p class="on"><?php echo e($pre_regs->dir); ?></p>
                 <p class="on"><?php echo e($pre_regs->id_user); ?></p>
                 <p class="on"><?php echo e($pre_regs->tlf); ?></p>
                 <p class="on"><?php echo e($pre_regs->plan_name); ?></p>
                 <?php if($pre_regs->type == 'at'): ?>
                 <p class="on">Antena</p>
                 <?php else: ?>
                 <p class="on">Fibra</p>
                 <?php endif; ?>
                 <p class="report_description" id="<?php echo e($j); ?>_screem_2"><?php echo e($pre_regs->observation); ?></p>
                 <p class="on"><?php echo e($pre_regs->server); ?></p>
                 <p><?php echo e($pre_regs->date_pay); ?></p>
                 <p class="on"><?php echo e($pre_regs->monto); ?>$</p>

                 <?php if(auth()->user()->role == 1 || auth()->user()->role == 2): ?>
                 <a class="btn btn-primary" onclick="show_edit('<?php echo e($k++); ?>')">editar</a>
                 <a href="<?php echo e(route('cliente.pay_report_add',$pre_regs->id)); ?>" class="btn btn-primary">Registrar</a>
                 <a href="<?php echo e(route('cliente.pay_report_del',$pre_regs->id)); ?>" class="btn btn-danger">X</a>
                 <?php else: ?>
                 <p>Editar</p>
                 <p>Registrar</p>
                 <p>Borrar</p>
     ...
     <script>
         function show_edit(id) {
             ...
             for (i = 1; i <= <?php echo e($pre_reg_count); ?>; i++) {
     ...
     <style>
         .edit_pre_reg {
             ...
             border-radius: 25px;
             padding: 5px;
             /*<?php echo e(route('cliente.pay_report_edit',$pre_regs->id)); ?>*/
         }
     ...
     <div class="edit_pre_reg wrapper" id="edit_pre_reg" style="display:none;">
         <?php $__currentLoopData = $pre_reg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pre_reg_edit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <form method="POST" action="<?php echo e(route('cliente.pay_report_edit',$pre_reg_edit->id)); ?>" class="container_edit drag" id="<?php echo e($l++); ?>" style="display:none;">
            <?php echo csrf_field(); ?>
            <label for="">
                Nombre:
                <br>
                <input type="text" name="name" value="<?php echo e($pre_reg_edit->full_name); ?>">
            </label>
             
            <label for="">
                Direccion:
                <br>
                <input type="text" name="dir" value="<?php echo e($pre_reg_edit->dir); ?>">
            </label>
             
            <label for="">
                Numero de cedula:
                <br>
                <input type="number" name="id_user" minlength="7" maxlength="8" value="<?php echo e($pre_reg_edit->id_user); ?>">
            </label>

            <label for="">
                Numero de telefono:
                <br>
                <input type="text" name="tlf" value="<?php echo e($pre_reg_edit->tlf); ?>">
            </label>
            ...
            <label for="">
                ...
                <select name="plan_name">
                    <?php $__currentLoopData = $planes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($pre_reg_edit->plan_name == $plan->nombre_de_plan): ?>
            ...
            <label for="">
                Observacion:
                <br>
                <textarea name="observation" id="" cols="15" rows="3" class="description_area"><?php echo e($pre_reg_edit->observation); ?></textarea>
            </label>
            ...
            <label for="server">
             ...
             <label for="">
                ...
                <br>
                <input type="date" name="insta_date" value="<?php echo e($pre_reg_edit->date_pay); ?>">
             </label>

             <label for="">
                Monto cancelado:
                <input type="number" name="total" id="" value="<?php echo e($pre_reg_edit->monto); ?>">
             </label>
     ...
     <script>
         ...
         function form_react() {
             ...
             for (let i = 1; i <= <?php echo e($reporte_count); ?>; i++) {
...
<?php echo $__env->make('layouts.side_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\control_de_pago\resources\views/reporte.blade.php ENDPATH**/ ?>